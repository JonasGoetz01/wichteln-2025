...
export default function EventManager({ className }: EventManagerProps) {
  ...
  const handleDelete = async (eventId: string) => {
    if (
      !confirm(
        "Bist du dir sicher, dass du dieses Event löschen möchtest? Diese Aktion kann nicht rückgängig gemacht werden.",
      )
    ) {
      return;
    }
          ...
          <div className="flex justify-between items-center w-full">
            <div>
              ...
              <p className="text-default-500">
                Erstelle und verwalte Wichtel-Events
              </p>
            </div>
            <Button
              color="primary"
                  ...
                  <TableCell>
                    <div className="text-sm">
                      {event.giftDeadline ? (
                        <>
                          <p>
                            {format(new Date(event.giftDeadline), "dd.MM.yyyy")}
                          </p>
                          <p className="text-default-500">
                  ...
                  <TableCell>
                    <div className="text-sm">
                      {event.deliveryDate ? (
                        <>
                          <p>
                            {format(new Date(event.deliveryDate), "dd.MM.yyyy")}
                          </p>
                          <p className="text-default-500">
            ...
            <ModalBody className="space-y-4">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                ...
                <div className="text-sm text-blue-600 dark:text-blue-300 space-y-1">
                  <p>
                    • Anmeldeschluss: Wann sollen sich alle registriert haben?
                  </p>
                  <p>
                    • Zuordnung: Wann werden die Wichtel-Partner zugewiesen?
                  </p>
                  <p>
                    • Geschenk-Abgabe: Bis wann müssen Geschenke abgegeben
                    werden?
                  </p>
